...
Per ulteriori informazioni sulle attività necessarie per creare le API, consulta [Creazione di API](/docs/services/apiconnect?topic=apiconnect-creating_apis).
