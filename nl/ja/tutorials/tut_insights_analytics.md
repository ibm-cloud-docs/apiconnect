...
## 目標
ここでは、{{site.data.keyword.apiconnect_long}}での API 分析の基本的な概要を取り上げます。独自の API を使用しながら、用意されている分析ダッシュボードの機能を確認してください。
...
[API のバージョン管理の方法](tut_version_landing.html)を学習します。
