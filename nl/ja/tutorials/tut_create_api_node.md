...
[REST サービスの管理](/docs/services/apiconnect/tutorials?topic=apiconnect-tut_rest_landing)または [SOAP サービスの管理](/docs/services/apiconnect/tutorials?topic=apiconnect-tut_manage_soap_api)に進みます。
