...
1. 시작하기 전에 [{{site.data.keyword.apiconnect_full}} 인스턴스를 설정](/docs/services/apiconnect?topic=apiconnect-tut_prereq_set_up_apic_instance)해야 합니다.
...
9. 이제 API가 작성됩니다. 디자인 페이지가 표시됩니다.

   ![](images/design-new-1.png)

10. 탐색줄에서 **정의**를 클릭하십시오. **정의 추가** 아이콘 ![](images/add-icon.png)을 클릭하십시오.
...
14. 탐색줄에서 **경로**를 클릭하십시오. **경로 추가** 아이콘 ![](images/add-icon.png)을 클릭하십시오.
15. 새로 작성된 경로의 **제목**을 `/getweatherdata`로 설정하십시오.
...
7. 아래로 스크롤하여 **우편번호** 필드로 이동하고 `10504`를 입력하십시오.  
