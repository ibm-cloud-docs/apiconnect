...
As a security officer, auditor, or manager, you can use the Activity Tracker service to track how users and applications interact with the {{site.data.keyword.apiconnect_full}} V10 Reserved plan service in {{site.data.keyword.cloud}}.
{: shortdesc}
...
Events that are generated by an {{site.data.keyword.apiconnect_short}} Reserved service are automatically forwarded to the {{site.data.keyword.at_full_notm}} service instance that is available in the same location.
